...
DIRS := lib common $(ARCHDIRS) backend cfrontend driver export cparser cklr demo rustfrontend rustparser rustdemo
...
RUSTDEMO=LinkedList.v LinkedListSafe.v HashMap.v HashMapSafe.v
