...
let option_drustsyntax = ref false
let option_drustlight = ref false
let option_drminor = ref false
let option_rcfg = ref false
let option_dinit = ref false
let option_dbefore_borrowck = ref false
let option_dmoveck = ref false
