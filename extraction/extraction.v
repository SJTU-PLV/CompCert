...
Extract Constant Compopts.borrowck_forward =>
  "fun _ -> !Clflags.option_fborrowck_forward".
...
Extract Constant ElaborateDrop.fresh_atom => "Dropglue.create_dropflag_ident".
