...
| match_callstate: forall vf fd orgs org_rels tyargs tyres cconv m fpl args k MP1 MP2 MP3 inout_fpl inout_locs inout_params tk fun_id tyl
    ...
    (WT_INOUTFP: list_forall2 (wt_footprint ce) tyl inout_fpl)
    (MPRED: m |= MP1 ** MP2 ** MP3)
    (STK: match_stacks k tk MP3),
    (* also disjointness of fpl and fpf *)
    match_states (RustIRspec.Callstate fun_id fpl inout_params (Mem.support m) k) (Callstate vf args tk m)
| match_returnstate: forall sg m k retty vfp v MP1 MP2 MP3 tk inout_locs inout_params inout_tyl inout_fpl
    ...
    (WTFP: wt_footprint ce retty vfp)
    (WT_INOUTFP: list_forall2 (wt_footprint ce) inout_tyl inout_fpl)
    (MPRED: m |= MP1 ** MP2 ** MP3)    
    (STK: match_stacks k tk MP3),
    match_states (RustIRspec.Returnstate vfp inout_params (Mem.support m) k) (Returnstate v tk m).
